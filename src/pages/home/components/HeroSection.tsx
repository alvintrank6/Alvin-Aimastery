...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden pt-28 md:pt-36 pb-16 md:pb-24 transition-colors duration-300">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-[#9B2A4C]/10 dark:bg-[#9B2A4C]/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#9B2A4C]/20 bg-[#9B2A4C]/5 text-[#9B2A4C] dark:text-rose-400 text-xs font-semibold">
            <i className="ri-map-pin-2-line text-[#9B2A4C] dark:text-rose-400" />
            Hanoi, Vietnam
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-12">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="text-xs font-bold uppercase tracking-widest text-[#9B2A4C] dark:text-rose-400">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.95] text-[#1C2526] dark:text-white">
              AI MARKETING
              <span className="block text-[#9B2A4C] dark:text-rose-400 font-extrabold mt-1">
                SPECIALIST
              </span>
            </h1>
          ...
          <div className="lg:col-span-4 flex justify-center relative my-4 lg:my-0">
            <div className="relative group">
              ...
              <div className="absolute -inset-3 rounded-3xl bg-gradient-to-tr from-[#9B2A4C]/30 via-rose-500/20 to-purple-600/20 blur-lg opacity-70 group-hover:opacity-100 transition-opacity" />
          ...
          <div className="lg:col-span-3 space-y-4 border-l border-gray-200 dark:border-gray-800 pl-0 lg:pl-6">
            <div className="p-4 rounded-2xl bg-white/60 dark:bg-[#131B2E]/60 border border-gray-100 dark:border-gray-800 shadow-sm backdrop-blur-md">
              <div className="flex items-center gap-2 text-[#9B2A4C] dark:text-rose-400 font-bold text-xs mb-1">
